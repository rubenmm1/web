...
if(isset($_POST['cod_presupuesto'])){
	...
	inner join tarifas t on t.cod_tarifa=c.id_tarifa
							...
							<div class=" main-content-body-invoice">
								<div class="card card-invoice">
									<div class="card-body">
										...
										<div class="table-responsive mg-t-40">
											<table class="table table-invoice border text-md-nowrap mb-0">
												...
												<tbody>
													...
													$sql="select a.*, p.*, p.descripcion as descripcion_linea from presupuestos_lineas p
													inner join articulos a on a.cod_articulo=p.id_articulo
													where id_presupuesto='".$cod_presupuesto."'";
											 ...
											 <tbody>
													...
													<tr>
														...
														<td class="tx-right" colspan="2" ><?php echo $tarifa;?> %</td>
													</tr>
													<tr>
														<td class="tx-right h5">Sub-Total</td>
														<td class="tx-right h5" colspan="2">
															<?php
																$subtotal_tarifa = $subtotal - ($subtotal*$tarifa/100);
										...
										<?php
										if(!$aceptado){
											echo '<bottom class="btn btn-success float-end mt-3 ms-2" id="btn_aceptar" cod='.$cod_presupuesto.'> Aceptar Presupuesto </bottom>';
										}
										?>
									</div>
								</div>
