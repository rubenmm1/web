...
<link href="assets/plugins/select2/css/select2.min.css" rel="stylesheet">
	...
	<body class="main-body">
			...
			<div class="main-content horizontal-content">
				...
				<div class="container">
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="my-auto">
							<div class="d-flex"><h4 class="content-title mb-0 my-auto">Presupuestos</h4><span class="text-muted mt-1 tx-13 ms-2 mb-0"></span></div>
						</div>
					</div>
					<!-- breadcrumb -->
								...
								<div class="card-body">
									<div class="table-responsive hoverable-table">
										<table id="tabla_listado" class="table text-md-nowrap">
											<thead>
												<tr>
													<th class='text-center'>NºPresupuesto</th>
					              ...
					              where id_cliente =".$_SESSION['cod_cliente'];
												...
												if($result->num_rows == 0){// Usuario web no existente
													...
													while($fila1 = $result->fetch_assoc()){
														if($fila1['aceptado']==1){
															$pagado="<span class='badge bg-success'>Aceptado</span>";
														}else{
														...
														<tr>
															...
															<td class='text-center wd-5p'><i class='far fa-file-pdf btn_pdf' cod=".$fila1['cod_presupuesto']."></i>&nbsp;&nbsp;<i class='fa fa-eye btn_mostrar' cod=".$fila1['cod_presupuesto']."></i></td>
														</tr>
														";
													}
												}
					...
					<form action="presupuestos-mostrar.php" method="post" id=form_mostrar_presupuesto>
						<input type="hidden" name="cod_presupuesto" id="cod_presupuesto" />
					</form>
					<form action="generar_presu_pdf.php" method="post" id=form_presu_pdf>
						<input type="hidden" name="cod_presupuesto_pdf" id="cod_presupuesto_pdf" />
					</form>
		...
		$(".btn_mostrar").on("click",function(){
			...
			$("#form_mostrar_presupuesto").submit();
		...
		$(".btn_pdf").on("click",function(){
			codigo = $(this).attr("cod");
			$("#cod_presupuesto_pdf").val(codigo)
			$("#form_presu_pdf").submit();
		})
