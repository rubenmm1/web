...
$cod_doc =$_POST['cod_presupuesto_pdf'];
///$cod_doc='POB22-0003';
/////********************
/////********************


$consulta="select c.*, f.fecha, s.descripcion as area  from presupuestos f
inner join clientes c on c.cod_cliente=f.id_cliente
inner join series s on s.cod_serie=f.cod_serie
where cod_presupuesto='".$cod_doc."'";
//echo $consulta;
...
class PDF extends FPDF
{
  ...
  //Rectangulo derecha
    ...
    $this->Cell(60,5,utf8_decode("PRESUPUESTO"),0,0,'L');
...
$sql = "SELECT * FROM presupuestos_lineas fl
INNER JOIN articulos a ON a.cod_articulo=fl.id_articulo
WHERE id_presupuesto='".$cod_doc."'";
//echo $sql;
...
//*TOTAL
  ...
  $sqlFactura="select * from presupuestos f
  where cod_presupuesto = '".$cod_doc."'";
  //echo $sqlFactura;
