...
<body class="main-body">
        ...
        <div class="main-content horizontal-content">
            ...
            <div class="container">
                ...
                <div class="breadcrumb-header justify-content-between">
                    ...
                    <div class="my-auto">
                        <div class="d-flex">
                            <h4 class="content-title mb-0 my-auto">Presupuestos</h4><span
                            ...
                            <div class="card card-invoice">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6" <?php if (isset($albaraneado)) {
                                            echo "style='display:none;'";
                                        } ?>>
                                            <label>Serie</label>
                                    ...
                                    <div class="table-responsive mg-t-40">
                                        <table class="table table-invoice border text-md-nowrap mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tx-right" colspan="2"><span id='tarifa_cliente'>0</span>%
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="tx-right h5">Sub-Total</td>
                                                    <td class="tx-right h5" colspan="2" id='txt_subotal_presupuesto'>
                                                        0.00 €</td>
                                                </tr>
                                                <tr>
                                                    <td class="tx-right">IVA (<span id='iva_cliente'></span>%)</td>
                                                    <td class="tx-right" colspan="2" id='txt_iva_presupuesto'>0.00 €
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tx-right" colspan="2">
                                                        <h4 class="tx-primary tx-bold" id='txt_total_presupuesto'>0.00 €
                                                        </h4>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <textarea id=observaciones name=observaciones rows=4
                                            style='width:100%;border:none;background-color:#edecec;font-size:13px;padding:10px;'><?php if (isset($observaciones)) {
                                                echo $observaciones;
                                            } ?></textarea>
                                    </div>
                                    <hr class="mg-b-40">
                                    ...
                                    if (!isset($albaraneado)) {
                                        ...
                                        echo '<bottom style="display:none" class="btn btn-success float-end mt-3 ms-2" id="btn_guardar">
											<i class="fa fa-save"></i> Guardar
										</bottom>';
                                    }
                ...
                <?php
                if (!isset($albaraneado)) { // En el caso que se haya albaraneado, no se muestra la busqueda de articulos
                    ?>
                    <div class="row row-sm">
                                ...
                                <div class="card-body p-2">
                                    <div class="input-group">
                                        ...
                                        <div class='col-md-6'>
                                            ...
                                            <select class="js-example-basic-single js-states form-control"
                                                name="combo_categoria" id="combo_categoria">
                                                <option></option>
                                                <?php
                    ...
                    <div class="modal-content modal-content-demo">
                        ...
                        <div class="modal-body">
                            <div class=row>
                                ...
                                <div class="col-3 pt-2 text-center">
                                    <label>Dto. %</label><br />
                                    <input style='width:45px;' type=number id="modal_dto" maxlength="1" max=999 min=0
                                        value="0" />
                                </div>
                                <div class="col-3 pt-2 text-center">
                        ...
                        <div class="modal-footer">
                            ...
                            <input type=hidden id='modal_cod_registro' />
    ...
    <script>
        ...
        $("#modal_btn_guardar").on("click", function () {
            ...
            codigo_articulo = $('#modal_cod_articulo').val();
            ...
            arrayArticulos[codigo][4] = codigo_articulo;//cod_articulo
        ...
        $(document).on('click', '.adtocart', function () {
            ...
            yaexiste = false;
            cod_registro = arrayArticulos.length;
            ...
            */
            if (guardar) {
                if (cantidad <= 0) {
                    ...
                    if (isset($albaraneado)) {
                        ?>
                        $("#lineas_presupuesto").append('<tr id="linea_presu_' + cod_registro + '" ><td id="txt_nombre_' + cod_registro + '">' + nombre + '</td><td id="txt_descripcion_' + cod_registro + '"></td><td class="tx-center"><div id="txt_cantidad_cod_ant_' + cod_registro + '">' + cantidad + '</div><input style="display:none;" cod="' + cod_registro + '" id="txt_cantidad_cod_' + cod_registro + '" type=number maxlength="1" min="1" max="999" value=' + cantidad + ' precio_uni="' + precio_uni + '" class="txt_cantidad_modificar"/></td><td class="tx-right" id="txt_precio_uni_' + cod_registro + '">' + precio_uni + ' €</td><td class="tx-center" id="txt_dto_' + cod_registro + '">0</td><td class="tx-right" id="txt_subtotal_' + cod_registro + '">' + subtotal + ' €</td></tr>')
                        <?php
                    } else {
                        ?>
                        $("#lineas_presupuesto").append('<tr id="linea_presu_' + cod_registro + '" ><td id="txt_nombre_' + cod_registro + '">' + nombre + '</td><td id="txt_descripcion_' + cod_registro + '"></td><td class="tx-center"><div id="txt_cantidad_cod_ant_' + cod_registro + '">' + cantidad + '</div><input style="display:none;" cod="' + cod_registro + '" id="txt_cantidad_cod_' + cod_registro + '" type=number maxlength="1" min="1" max="999" value=' + cantidad + ' precio_uni="' + precio_uni + '" class="txt_cantidad_modificar"/></td><td class="tx-right" id="txt_precio_uni_' + cod_registro + '">' + precio_uni + ' €</td><td class="tx-center" id="txt_dto_' + cod_registro + '">0</td><td class="tx-right" id="txt_subtotal_' + cod_registro + '">' + subtotal + ' €</td><td class="tx-center"><i class="fa fa-edit btn_modificar" cod="' + cod_registro + '"></i></td><td class="tx-center"><i class="far fa-trash-alt btn_eliminar_linea" cod=' + cod_registro + '></i></td></tr>')
                        <?php
                    }
                    ?>
        ...
        $(document).on('click', '.btn_eliminar_linea', function () {
            codigo = $(this).attr("cod")
            if (confirm("Deseas eliminar este artículo del presupuesto?")) {
                $("#linea_presu_" + codigo).remove();
                arrayArticulos[codigo] = [0, 0, "", 0, 0];
                SumarTotal();
            }
        })
        ...
        function SumarTotal() {
            ...
            arrayArticulos.forEach(function (valor, indice, array) {
                ...
                // console.log(subtotalinea);
                sumatorio += subtotalinea;
        ...
        const handleSave = () => {
            ...
            if (cod_cliente == "") {
                Swal.fire("Debes seleccionar un cliente", "", "warning");
            } else {
                hayArticulos = false;
                arrayArticulos.forEach(function (valor, indice, array) {
                    if (valor[0] != 0) {
                ...
                if (cod_serie == "") {
                    Swal.fire("Debes seleccionar una serie", "", "warning");
                }
                else {
                    if (!hayArticulos) {
                        Swal.fire("No hay articulos seleccionados", "", "warning");
                    } else {
                        Swal.fire({
                            title: 'Seguro desea guardar el presupuesto?',
                            showDenyButton: true,
                            ...
                            if (result.isConfirmed) {
                                ...
                                Swal.fire("Presupuesto no guardado", "", "info");
                            }
                        });
