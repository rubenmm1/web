    ...
    <div class="horizontal-mainwrapper container clearfix">
      ...
      <nav class="horizontalMenu clearfix">
        <ul class="horizontalMenu-list">
          ...
          if ($_SESSION['tipo'] == 0) {
            ?>
            <li aria-haspopup="true"><a href="articulos.php" class=""><svg xmlns="http://www.w3.org/2000/svg"
            ...
            <li aria-haspopup="true"><a href="#" class="sub-icon">
                ...
                Informes<i class="fe fe-chevron-down horizontal-icon"></i></a>
              <ul class="sub-menu">
                <li aria-haspopup="true"><a href="infor_facturas.php" class="">Facturas</a></li>
                <li aria-haspopup="true"><a href="infor_pagos.php" class="">Pagos</a></li>
              </ul>
            </li>
            <?php
          }
          ...
          if ($_SESSION['tipo'] == 0) {
            ...
            <li aria-haspopup="true"><a href="#" class="sub-icon">
                ...
                Facturacion<i class="fe fe-chevron-down horizontal-icon"></i></a>
              <ul class="sub-menu">
                <li aria-haspopup="true"><a href="presupuestos.php" class="">Presupuestos</a></li>
                <li aria-haspopup="true"><a href="albaranes.php" class="">Albaranes</a></li>
          ...
          if ($_SESSION['tipo'] == 0) {
            ...
            <li aria-haspopup="true"><a href="#" class="sub-icon">
                ...
                Configuración<i class="fe fe-chevron-down horizontal-icon"></i>
              </a>
              <ul class="sub-menu">
                <li aria-haspopup="true"><a href="operarios.php" class="">Gestion de Operarios</a></li>
                <li aria-haspopup="true"><a href="series.php" class="">Gestión de Series</a></li>
              </ul>
            </li>
            <?php
          }
