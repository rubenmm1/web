...
<body class="main-body">
		...
		<div class="main-content horizontal-content">
			...
			<div class="container">
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Informes Facturación</h4>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
							...
							<div class="card-body">
								<div class="row pb-3 pt-3"><!-- panel de busqueda -->
									...
									<div class="col-md-2">
										...
										<label class="ckbox"><input type="checkbox" id='cb_pendiente'
												class="form-control"><span></span></label>
									</div>

									<div class="col-md-3 text-right">
										<br />
										<div class="btn btn-primary" id='btn_filtrar' /><i class="fas fa-filter"></i>
										filtrar
									</div>
								</div>
	...
	<script>
		...
		$("#btn_filtrar").on("click", function () {
			...
			pagada = $("#cb_pendiente").is(":checked");

			$.ajax({
				url: 'filtrar_facturas_jquery.php',
				type: 'post',
				dataType: 'JSON',
				data: "cliente=" + cliente + "&f_desde=" + f_desde + "&f_hasta=" + f_hasta + "&pagada=" + pagada,
				beforeSend: function () {
					table.clear().draw();
				},
				success: function (response) {
